//  Copyright (c) 2000-2017 ZEDO Inc. All Rights Reserved.
var q10="http://xp2.zedo.com/asw";var r11=new function(){var z6=this;
z6.zd_has_flash=false;
...
var v7='application/x-shockwave-flash';var p5=navigator.mimeTypes;
if(p5&&p5[v7]&&p5[v7].enabledPlugin&&p5[v7].enabledPlugin.description){
z6.zd_has_flash=true;
}
...
var w3=navigator.userAgent.toLowerCase();var r18=(w3.indexOf('mac')!=-1);var n18=parseInt(navigator.appVersion);
var n19=(!r18&&(w3.indexOf('opera')==-1)&&(w3.indexOf('msie')!=-1)&&(n18>=4)&&(w3.indexOf('webtv')==-1
)&&(w3.indexOf('msie 4')==-1));
var w16=navigator.javaEnabled();var y2=1;var a27=document.createElement("audio");var d31=document.createElement("video");var e20={audio:(a27.play)?true:false,video:(d31.play)?true:false};
if(e20.audio&&e20.video){
y2 |=128;
}
if(w16){y2 |=4;}
if(r11.zd_has_flash){y2 |=8;}
if(n19){
...
var zd_networkID=0;var n0='';var q5=0;var zd_passback_publisherID;var zd_passback_networkID;var zd_passback_eventId;var zd_passback_adId;var zd_passback_channelId;
...
var zl_dm_params=zd_dm_params;var zl_dm_values=new Array();var a16=new RegExp(",","g");
...
if(zl_dm_values[i]!=""){
zl_dm_values[i]=zl_dm_values[i].replace(a16,"Z");
}}}
return zl_dm_values;
}
...
var zzState=0;}var zzSection=q5;var zzPbNId=zd_passback_networkID;var zzPbEId=zd_passback_eventId;var zzPbAId=zd_passback_adId;var zzPbCId=zd_passback_channelId;var zzPbGeoLvl=zd_passback_geoLevel;
var zzPbk=zd_Pbk;
...
var o17="";
try{
var z26=zd_get_domain(zd_detect_page_url(isJsTag));var n20=zd_get_top_parent_stack_url().split("?")[0];var q25=zd_get_domain(decodeURIComponent((zd_pg_url)));
o17=encodeURIComponent(z26+"_"+n20+"_"+q25+"_"+zd_get_stack_url_depth(n20)+"_"+zd_get_friendly_iframe_depth()+"_"+zd_pg_url);
}catch(t){}
return o17;
}
